          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="small-box bg-warning">
                <div class="inner">
                  <div class="row" style="padding-left:6px">
                    <h3 style="color: white" class="count">
                    <!-- menghitung jumlah pemohon berbayar -->
                      <?php foreach ($data_pemohon as $d) { ?>
                        <?php $b = $d->count; ?>
                      <?php } ?>
                      <!-- menghitung jumlah pemohon 0 rupiah -->
                      <?php foreach ($data_pemohon1 as $d) { ?>
                        <?php $a = $d->count; ?>
                      <?php } ?>
                      <!-- total -->
                      <?php echo $a + $b; ?>
