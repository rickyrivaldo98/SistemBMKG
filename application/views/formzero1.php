    ...
    <div class="jumbotron">
        ...
        <div class="container">
            <div class="card">
                ...
                <form action="<?php echo base_url() . 'page/upload_data1'; ?>" method="POST" enctype="multipart/form-data" >
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="card-body">
                            ...
                            <div class="custom-file">
                                <input name="PDF1" type="file" class="custom-file-input <?php echo form_error('PDF1') ? 'is-invalid' : '' ?>" id="exampleInputFile"></input>
                                <label class="custom-file-label" for="exampleInputFile">Masukkan File Surat Pengantar</label>
                                <div class="invalid-feedback">
                                    <?php echo form_error('PDF1') ?>
                                </div>
                            </div>

                            <label for="pdf">Unggah file Proposal<span style="color: red">(PDF)</span> </label>

                            <div class="custom-file">
                                <input name="PDF2" type="file" class="custom-file-input <?php echo form_error('PDF2') ? 'is-invalid' : '' ?>" id="exampleInputFile"></input>
                                <label class="custom-file-label" for="exampleInputFile">Masukkan File Proposal</label>
                                <div class="invalid-feedback">
                                    <?php echo form_error('PDF2') ?>
                                </div>
                            </div>

                            <label for="pdf">Unggah file surat Pernyataan <span style="color: red">(PDF)</span> </label>

                            <div class="custom-file">
                                <input name="PDF3" type="file" class="custom-file-input <?php echo form_error('PDF3') ? 'is-invalid' : '' ?>" id="exampleInputFile"></input>
                                <label class="custom-file-label" for="exampleInputFile">Masukkan Surat Pernyataan</label>
                                <div class="invalid-feedback">
                                    <?php echo form_error('PDF3') ?>
                                </div>
                            </div>
                            <br><br>
                            <div class="form-group">
